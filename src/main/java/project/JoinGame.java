 ...
 * @author nickbenoit
 */
public class JoinGame extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JoinGame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
